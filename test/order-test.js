    ...
    _updateOrderHandler(done) {
        ...
        chai.request(server)
            ...
            .end((err, res) => {
                ...
                res.should.have.status(200);
                res.body.data.content.result.should.be.a('object');
                res.body.data.content.result.should.have.property('productIds').eql('32773', '32774', '32775');
                res.body.data.content.result.should.have.property('orderId');
                res.body.data.content.result.should.have.property('itemId');
                res.body.data.content.result.should.have.property('time_created');
                es.body.data.content.result.should.have.property('status').eql('');
